        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href="{{ route('admin.coupon.add') }}"><i class="icon-plus"></i> Tambah Kupon Diskon</a>
                </div>
                        ...
                        <table class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Tipe Kupon</th>
                                    <th>Nominal Kupon</th>
                                    <th>Jumlah Kupon Diskon</th>
                                    <th>tanggal kadaluarsa kupon</th>
                                    <th>Opsi</th>
                                </tr>
                            </thead>
                            <tbody>
