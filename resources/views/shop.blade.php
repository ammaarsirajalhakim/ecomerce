                                ...
                                <ul class="list list-inline mb-0 brand-list">
                                    @foreach ($brands as $brand)
                                        <li class="list-item">
                                            ...
                                            <span class="float-end">{{ $brand->products->count() }}</span>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                    ...
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value=""
                                ...
                                data-slider-value="[{{ $min_price }},{{ $max_price }},450]" data-currency="$" />
              ...
              "clickable": true
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0 ml-2"
                            style="margin-right: 20px" name="size" id="pagesize"
                            onchange="document.getElementById('form-size').submit()">
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0 ml-2"
                            name="order" id="orderby" onchange="document.getElementById('form-order').submit()">
                            <option value="-1" {{ $order == -1 ? 'selected' : '' }}>Default</option>
                            <option value="1" {{ $order == 1 ? 'selected' : '' }}>Tanggal, Baru ke Lama</option>
                            <option value="2" {{ $order == 2 ? 'selected' : '' }}>Tanggal, Lama ke Baru</option>
                            <option value="3" {{ $order == 3 ? 'selected' : '' }}>Harga, Tinggi ke Rendah</option>
                            <option value="4" {{ $order == 4 ? 'selected' : '' }}>Harga, Rendah ke Tinggi</option>
                        </select>
                        {{-- </form> --}}
                        ...
                        <div class="product-card-wrapper">
                            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                <div class="pc__img-wrapper">
                                    ...
                                    @if ($inCart)
                                        <a href="{{ route('cart.index') }}"
                                            class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn-warning">Lihat
                                            Keranjang</a>
                                    @else
                                        <form action="{{ route('cart.add') }}" method="POST" name="addtocart-form">
                                            ...
                                            <button
                                                ...
                                                data-aside="cartDrawer" title="Add To Cart">Masukkan Keranjang</button>
                                        </form>
                                    @endif
                                </div>
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    @if ($inWishlist)
                                        <form action="{{ route('wishlist.item.remove', ['product_id' => $product->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
