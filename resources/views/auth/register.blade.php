...
<style>
    ...
    .register-wrapper {
        display: flex;
        min-height: 90vh; /* Mengisi tinggi viewport, disesuaikan agar tidak terlalu ke bawah */
        align-items: center;
    ...
    .register-form-container {
        flex-basis: 50%;
        padding: 40px; /* Sedikit disesuaikan agar pas */
        display: flex;
    ...
    .register-form-container .text-muted {
        margin-bottom: 25px; /* Sedikit disesuaikan */
        font-size: 0.9rem;
    }
    ...
    .form-control {
        ...
        padding: 10px 15px; /* Disesuaikan tingginya */
        height: auto;
