                ...
                <div class="col-lg-5">
                    <div class="d-flex justify-content-between mb-4 pb-md-2">
                        ...
                        <div
                            ...
                            @php
                                $prevProduct = \App\Models\Product::where('id', '<', $product->id)
                                    ->orderBy('id', 'desc')
                                    ->first();
                            @endphp
                            @if ($prevProduct)
                            ...
                            @php
                                $nextProduct = \App\Models\Product::where('id', '>', $product->id)
                                    ->orderBy('id', 'desc')
                                    ->first();
                            @endphp
                            @if ($nextProduct)
                    ...
                    <div class="product-single__rating">
                        ...
                        <span class="reviews-note text-lowercase text-secondary ms-1">8k+ review</span>
                    </div>
                    <div class="product-single__price">
                        <span
                            class="current-price">Rp. {{ $product->sale_price == '' ? $product->regular_price : $product->sale_price }}</span>
                    </div>
                            ...
                            <form action="{{ route('wishlist.add') }}" method="POST" id="wishlist-form">
                                ...
                                <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist"
                                    onclick="document.getElementById('wishlist-form').submit();"><svg width="16"
                                        ...
                                        xmlns="http://www.w3.org/2000/svg">
                                        <use href="#icon_heart" />
                                    </svg><span> Masukkan Wishlist</span></a>
                            </form>
                        @endif
                        <share-button class="share-button">
                            <button
                                class="menu-link menu-link_us-s to-share border-0 bg-transparent d-flex align-items-center" style="padding: 0 !important">
            ...
            <div class="product-single__details-tab">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link nav-link_underscore" id="tab-reviews-tab" data-bs-toggle="tab"
                            href="#tab-reviews" role="tab" aria-controls="tab-reviews" aria-selected="false">Review
                            (2)</a>
                    </li>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-reviews" role="tabpanel" aria-labelledby="tab-reviews-tab">
                        <h2 class="product-single__reviews-title">Review</h2>
