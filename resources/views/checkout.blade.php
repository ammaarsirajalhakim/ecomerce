                            ...
                            <div class="row mt-4" id="address-form-fields">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="d-flex mt-2">
                                        ...
                                        <div class="form-check me-3">
                                            <input class="form-check-input" type="radio" name="type" id="type_kantor" value="Kantor" {{ old('type') == 'Kantor' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="type_kantor">Kantor</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="type" id="type_lainnya" value="Lainnya" {{ old('type') == 'Lainnya' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('country') is-invalid @enderror" id="country" name="country" value="{{ old('country', 'Indonesia') }}" required>
                                ...
                                <table class="checkout-totals">
                                    <tbody>
                                        @if (Session::has('discounts'))
                                            <tr>
                                                <th>Subtotal</th>
                                                <td class="text-right">Rp. {{ number_format(Session::get('discounts')['subtotal'] + Session::get('discounts')['discount'], 0, ',', '.') }}</td>
                                            </tr>
                                            <tr>
